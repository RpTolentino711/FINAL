      ...
      <div class="card p-4 mb-5">
        ...
        <form method="post" enctype="multipart/form-data" class="row g-3" autocomplete="off">
          ...
          <div class="col-12">
            ...
            <input id="name" type="text" class="form-control form-control-lg" name="name" placeholder="Unit name" required />
          </div>
          <div class="col-12">
            <label for="spacetype_id" class="form-label fw-semibold">Space Type <span class="text-danger">*</span></label>
            <select id="spacetype_id" name="spacetype_id" class="form-select form-select-lg" required>
          ...
          <div class="col-12">
            ...
            <input id="price" type="number" step="100" min="0" class="form-control form-control-lg" name="price" placeholder="0.00" required />
      ...
      <div class="card p-4 mb-5">
        ...
        <form method="post" class="row g-3" autocomplete="off">
          ...
          <div class="col-12">
            ...
            <input id="spacetype_name" type="text" class="form-control form-control-lg" name="spacetype_name" placeholder="e.g. Apartment, Studio, Commercial" required />
          </div>
          <div class="col-12 text-center mt-4">
